...
export default async function Page() {
  ...
  return <div className="bg-[#F6F1E8] px-6 py-14">
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <section className="rounded-3xl border border-[#123F2A]/10 bg-white p-7 shadow-soft"><h2 className="text-2xl font-bold text-[#123F2A]">O que é agricultura orgânica</h2><p className="mt-3 text-slate-700">É um sistema de produção baseado no equilíbrio do solo, biodiversidade e manejo sustentável, com menor dependência de insumos químicos sintéticos. Valoriza a saúde do solo, da água, das plantas e do consumidor, com planejamento e rastreabilidade.</p></section>
      ...
      <section className="rounded-3xl border border-[#123F2A]/10 bg-white p-7 shadow-soft"><h2 className="text-2xl font-bold text-[#123F2A]">Agricultura orgânica para hortaliças</h2><p className="mt-3 text-slate-700">A consultoria contempla produção orgânica de hortaliças, tomateiro e melancia com foco em produção de mudas, tratos culturais, nutrição, fitossanidade, caldas alternativas e manejo integrado de pragas e doenças.</p></section>
