  ...
  async function fillWithAI() {
    ...
    try {
      ...
      if (!r.ok) {
        ...
        else if (errorCode === "ai_network_error") setErr("Falha temporária de conexão com o serviço de IA. Tente novamente em instantes.");
        else if (errorCode === "ai_provider_unavailable") setErr("O serviço de IA está temporariamente indisponível. Tente novamente em instantes.");
        ...
        else if (r.status >= 500) setErr("O servidor não conseguiu concluir a solicitação de IA agora. Tente novamente em instantes.");
      ...
      setErrCode("(falha_de_rede_no_frontend)");
    } finally {
      setAiLoading(false);
    }
  }
