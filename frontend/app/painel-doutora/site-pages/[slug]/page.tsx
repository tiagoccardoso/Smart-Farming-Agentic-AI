...
<button type="submit" disabled={saving||uploading} className="rounded-full bg-leaf-600 px-6 py-3 font-semibold text-white disabled:bg-[#c1c9c1]">{saving ? "Salvando..." : uploading ? "Aguarde upload..." : "Salvar alterações"}</button></form></div>;
}
