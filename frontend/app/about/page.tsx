    ...
    <div className="mx-auto max-w-5xl px-6 py-14">
      ...
      <div className="space-y-6 text-[#414943]">
        ...
        <div className="rounded-2xl border border-sun-200 bg-sun-50 p-6">
          <h4 className="text-lg font-semibold text-[#1d1c16]">Limitações</h4>
