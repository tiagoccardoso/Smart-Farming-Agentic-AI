  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-16 sm:px-6 lg:px-8">
      <div className="rounded-[2rem] border border-amber-200 bg-amber-50 p-6 shadow-soft sm:p-8">
        <p className="text-xs font-bold uppercase tracking-[0.2em] text-amber-700">Pagamento nao concluido</p>
        <h1 className="mt-3 text-2xl font-black text-amber-900 sm:text-3xl">Voce cancelou o pagamento.</h1>
        <p className="mt-4 text-sm leading-6 text-amber-900">
          Nada foi cobrado e seu plano atual continua como estava. Voce pode retomar a contratacao quando quiser.
        </p>
